(function ($tool) {
    ...
    let reportEmail = "webaccount@lenkor.cn"
    ...
    let Report = function () {
        this.reportType = "sp-search-terms"
        this.tabId = null;
    }
    const SETTING_KEY = "sp_search_terms_setting";
    Report.prototype = {
        ...
        saveSetting: function (setting, cb) {
            $tool.log.info(`${this.reportType}:` + setting);
            let item = {};
        ...
        down(date, site, setting, save) {
            ...
            let lk_ajax_options = "spst_options" + date.format('yyyyMMdd')
    ...
    $tool.registerReport({spst: new Report()})
