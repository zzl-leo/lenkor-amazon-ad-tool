(function ($tool) {
    ...
    let SBVideoCam = function () {
        this.reportType = "sbv-c"
        this.tabId = null;
    }
    const SETTING_KEY = "sb_video_c_setting";

    SBVideoCam.prototype = {
        ...
        saveSetting: function (setting, cb) {
            $tool.log.info("sb_video_c:" + setting);
            let item = {};
        ...
        rangeDayDown(begin, end, site, setting, save) {
            console.log(begin.format(), end.format())
    ...
    $tool.registerReport({sbvc: new SBVideoCam()})
})(adTool)